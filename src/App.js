...
import SinglePlace from "./component/Admin/SinglePlace";
import AddSingleplace from "./component/Admin/AddSingleplace";
    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route
            path="/single-package-page/:id/:slug"
            element={<SinglePackagepage />}
          ></Route>

          <Route path="/add-single-city" element={<AddSinglePackage />}></Route>
          <Route path="/add-single-place" element={<AddSingleplace />}></Route>
          <Route
            path="/single-place-page/:id/:slug"
            element={<SinglePlace />}
          ></Route>
          {/* </Route> */}
